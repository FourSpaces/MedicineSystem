...
<views:override name="page_content">
    <div class="row">
        ...
        <div class="col-lg-4" style="display:none;">
                <%-- 验证用户账号真实性 start--%>
            <div id="" class="">
                <legend class=""><h4>历史开药记录</h4></legend>
            </div>
            <!-- 临床挂号 -->
            <div class="col-md-10" id="drugsListss"  style="font-size: 12px;"></div>
        </div>
        <!-- 诊断 -->
        <div class="col-lg-8">
            <div id="" class="">
            ...
            <form:form class="form-horizontal"  method="post" action="${__ROOT__}/inpatient/diagnosis" commandName="diagnosis" role="form">
                <fieldset>
...
<views:override name="page_script">
    ...
    <script>
        ...
        function inits(josn) {
            ...
            //生成表格
            $.jsonToTable(jsonTable, { id: "#drugsListss",header: true, className: "table table-striped"});
        };

        <c:forEach items="${diagnosisList}" var="diagnosis">
            inits('${diagnosis.content}');
        </c:forEach>
